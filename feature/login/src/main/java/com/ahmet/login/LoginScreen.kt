...
import com.ahmet.designsystems.component.CustomTextField
...
private fun UserNameTextField(
    ...
    com.ahmet.designsystems.component.CustomTextField(
        modifier = modifier
            .fillMaxWidth()
...
fun LoginScreenPreview() {
    com.ahmet.designsystems.theme.composecodebaseTheme() {
        Content(
            LoginViewState(),
